...
const EditExpenseModal = ({ expense, onClose, onUpdated }) => {
  ...
  const hasChanges = useCallback(() => {
    return (
      ...
      String(formData.amount) !== String(originalData.amount) ||
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Edit expense failed", err.response?.data || err);
  ...
  const showResetButton = hasChanges();
      ...
      <div className="modal" ref={modalRef}>
        <div className="modal-header">
          <div className="header-content">
            <h3 id="modal-title">Edit Expense</h3>
            {expense.createdAt && (
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            ...
            {originalData.amount !== formData.amount && formData.amount && (
              <span className="change-indicator">
                Original: ₹{Number(originalData.amount).toLocaleString()}
              </span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {originalData.date !== formData.date && (
              <span className="change-indicator">
                Original: {new Date(originalData.date).toLocaleDateString()}
              </span>
            )}
          </div>
          ...
          <div className="modal-actions">
            <button
              ...
              disabled={formState.isSubmitting || !isFormValid || !hasChanges()}
            >
            ...
            {showResetButton && !formState.isSubmitting && (
              <button
                type="button"
